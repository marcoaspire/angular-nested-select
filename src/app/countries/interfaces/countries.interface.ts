...
//
//   const countryLong = Convert.toCountryLong(json);
//
...
export class Convert {
  public static toCountryLong(json: string): CountryLong[] {
      return cast(JSON.parse(json), a(r("CountryLong")));
  }

  public static countryLongToJson(value: CountryLong[]): string {
      return JSON.stringify(uncast(value, a(r("CountryLong"))), null, 2);
  }
}
